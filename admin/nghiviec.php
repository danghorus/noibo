...
<?php
	if (isset($_POST["btn_submit"])) {
		...
		//Kiểm tra điều kiện bắt buộc đối với các field không được bỏ trống
			$sql = "INSERT INTO yeucau(loaiyeucau ,nguoiyeucau, ngaytu, lydo, nguoiduyet, trangthaiduyet, ngaygui) 
            VALUES ( '$loaiyeucau', '$nguoiyeucau', '$ngaytu', '$lydo', '$nguoiduyet', '$trangthaiduyet', now())";
            ...
            <ul class="form-section page-section" style="background-color:#eaeeee;border-radius:10px;">
                <li id="cid_34" class="form-input-wide" data-type="control_head">
                    <div class="form-header-group  header-large">
                        <input class="" name="loaiyeucau" id="loaiyeucau" value="Nghỉ việc" style="font-size:35px; border:0px; background-color:#eaeeee; margin-left:30%;" readonly>
                    </div>
                </li>
                <li class="form-line">
                    ...
                    <div class="form-input-wide">
                        <span class="form-sub-label-container" style="vertical-align:top">
                            <input type="text" name="nguoiyeucau" id="nguoiyeucau" class="form-textbox" style="width:310px" data-masked="true" value="" />
                        </span>
                    </div>
                </li>
                <li class="form-line">
